...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("StudentTabularDetailsAndExportView.fxml"));
        connection = DBConnectionFactory.getConnection(Database.MYSQL);
        StudentTabularDetailsAndExportController controller = new StudentTabularDetailsAndExportController(connection);
